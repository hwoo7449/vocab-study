                            ...
                            <div className="mt-4">
                                ...
                                {showAdminButtons && (
                                    <>
                                        ...
                                        <Link href="/admin/reported-words">
                                            <div className="mt-2 px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600 text-center cursor-pointer">
                                                Manage Reported Words
                                            </div>
                                        </Link>
                                    </>
                                )}
